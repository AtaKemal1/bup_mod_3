...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.025        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
...
NDefines.NSupply.CAPITAL_SUPPLY_BASE = 50
